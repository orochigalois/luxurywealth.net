...
const EmblaCarouselAlt2 = ({ slides, notifyPrev, notifyNext}) => {
    ...
    const scrollPrev = useCallback(() => { embla && embla.scrollPrev(); notifyPrev() }, [embla]);
    const scrollNext = useCallback(() => { embla && embla.scrollNext(); notifyNext() }, [embla]);
                        ...
                        {slides.map((slide, index) => (
                            <div className="embla__slide" key={index}>
                                <div className="embla__slide__inner">
                                    <div className="img__wrapper" style={{ paddingTop: 568 + 'px' }}>
                                        <img
