                        ...
                        {slides.map((slide, index) => (
                            <div className="embla__slide" key={index}>
                                <div className="embla__slide__inner">
                                    <div className="img__wrapper" style={{paddingTop:`${100*slide.attributes.image.data.attributes.height/slide.attributes.image.data.attributes.width}%`}}>
                                        <img
                                            className="embla__slide__img"
                                            src={getStrapiMedia(slide.attributes.image.data.attributes.url)}
                                            alt=""
                                    ...
                                    <div className="subtitle__date">
                                        <div className="subtitle"><p>{slide.attributes.category}</p></div>
                                        <div className="date">{moment(slide.attributes.createdAt).format('MMMM D, YYYY').toUpperCase()}</div>
                                    </div>
                                </div>
                            </div>
                        ))}
